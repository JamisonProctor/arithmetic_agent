...
def load_agent(model_name: str):
    ...
    tool_calls_log = []  # <-- NEW LOGGING LIST
    ...
    # Use new builder with logging
    agent_graph = build_assistant_with_tools_and_logging(llm, basic_tools, sys_msg, tool_calls_log)

    return agent_graph, tool_calls_log  # <-- NOTE: return both